...
import { EXCHANGE_CONTRACT_ABI, EXCHANGE_CONTRACT_ADDRESS } from "../constants/index";

/**
 * removeLiquidity: Removes the `removeLPTokensWei` amount of LP tokens from
 * liquidity and also the calculated amount of `ether` and `CD` tokens
 */
// ** It's a BigNumber, right?
export const removeLiquidity = async (signer: ethers.providers.JsonRpcSigner, removeLPTokensWei: BigNumber) => {
    try {
